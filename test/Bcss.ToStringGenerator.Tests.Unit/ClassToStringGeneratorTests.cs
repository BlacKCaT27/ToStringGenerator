...
public partial class SensitiveCollectionsExample
{
    ...
    public Dictionary<string, string> Secrets { get; set; } = new()
    {
        ...
        [TestMethod]
        public void GenerateToString_DoesNotOutputPrivateMembers_BasedOn_MSBuild_Config()
        {
            // Arrange
            var source = @"
using Bcss.ToStringGenerator.Attributes;
...
public partial class TestClass
{
    ...
    private protected int Age4;
        ...
        [TestMethod]
        public void GenerateToString_OutputsPrivateMembers_BasedOn_AttributeLevel_Config()
        {
            // Arrange
            var source = @"
using Bcss.ToStringGenerator.Attributes;
...
public partial class TestClass
{
    ...
    private protected int Age4;
            ...
            Assert.IsTrue(generatedCode.Contains("sb.Append(\", Age = \")"), "Generated code should contain private field name `Age` when includePrivateDataMembers is true.");
            Assert.IsTrue(generatedCode.Contains("sb.Append(Age.ToString())"), "Generated code should contain private field value `Age` when includePrivateDataMembers is true.");
            ...
            Assert.IsTrue(generatedCode.Contains("sb.Append(\", Age4 = \")"), "Generated code should contain private field name `Age4` when includePrivateDataMembers is true.");
            Assert.IsTrue(generatedCode.Contains("sb.Append(Age4.ToString())"), "Generated code should contain private internal field value `Age4` when includePrivateDataMembers is true.");
        }
        
        [TestMethod]
        public void GenerateToString_OutputsPrivateMembers_BasedOn_NamedAttributeLevel_Config()
        {
            // Arrange
            var source = @"
using Bcss.ToStringGenerator.Attributes;
